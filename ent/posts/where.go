...
func ID(id int) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func Body(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func PublishAt(v time.Time) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyEQ(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldBody), v))
	})
}
...
func BodyNEQ(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyIn(vs ...string) predicate.Posts {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func BodyNotIn(vs ...string) predicate.Posts {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func BodyGT(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyGTE(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyLT(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyLTE(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyContains(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyHasPrefix(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyHasSuffix(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyEqualFold(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func BodyContainsFold(v string) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func PublishAtEQ(v time.Time) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldPublishAt), v))
	})
}
...
func PublishAtNEQ(v time.Time) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func PublishAtIn(vs ...time.Time) predicate.Posts {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PublishAtNotIn(vs ...time.Time) predicate.Posts {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PublishAtGT(v time.Time) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func PublishAtGTE(v time.Time) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func PublishAtLT(v time.Time) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func PublishAtLTE(v time.Time) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
...
func HasUserWith(preds ...predicate.Users) predicate.Posts {
	return predicate.Posts(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
